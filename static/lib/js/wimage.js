...
(function() {
  ...
  ImageButton = (function(superClass) {
    ...
    ImageButton.prototype.name = 'wimage';
    ...
    ImageButton.prototype.createImage = function(name) {
      var $annot, $block, $img, $nextBlock, range;
      if (name == null) {
        name = 'Image';
      }
      ...
      $annot = $('<p class="img-annot"></p>');
      range.insertNode($annot[0]);
  ...
  ImagePopover = (function(superClass) {
    ...
    ImagePopover.prototype.render = function() {
      ...
      this.annotEl.on('keyup', (function(_this) {
        return function(e) {
          var $annot, _annotText, ref;
          if ((ref = e.which) === 13 || ref === 27 || ref === 9) {
            return;
          }
          _annotText = _this.annotEl.val();
          $annot = _this.target.next('p.img-annot');
          if ($annot.length === 0) {
            $annot = _this.target.parent().next('p.img-annot');
          }
          return $annot.text(_annotText);
        };
      })(this));
