...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor', ["jquery.tablednd.js","simple-module","simple-hotkeys","simple-uploader"], function ($, SimpleModule, simpleHotkeys, simpleUploader) {
...
Simditor = (function(superClass) {
  ...
  Simditor.prototype._render = function() {
    ...
    this.body = this.wrapper.find('.page');
